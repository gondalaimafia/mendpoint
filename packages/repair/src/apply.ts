 ...
 *
 * Sourced from the single canonical denylist ({@link DEFAULT_POLICY.neverTouchPaths})
 * rather than a re-declared local copy, so repair can never protect a narrower
 * set of paths than the policy engine.
 */
