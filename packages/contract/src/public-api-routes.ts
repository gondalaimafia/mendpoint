...
export const PUBLIC_DOCS_API_ROUTES = Object.freeze([
  ...
  "GET /agent/runs/:id",
  "GET /audit",
  "GET /audit-governance/destinations",
  "GET /audit-governance/exports/:id",
  "GET /audit-governance/exports/:id/replay",
  "GET /audit-governance/legal-holds",
  "GET /audit-governance/retention",
  "GET /audit/export",
  "GET /billing/plans",
  "GET /billing/usage",
  ...
  "POST /audit-governance/destinations",
  "POST /audit-governance/destinations/:id/revoke",
  "POST /audit-governance/exports",
  "POST /audit-governance/legal-holds",
  "POST /audit-governance/legal-holds/:id/release",
