...
export function validateApiEnv(env: NodeJS.ProcessEnv = process.env): EnvReport {
  ...
  const values: Record<string, string | undefined> = {
    ...
    MENDPOINT_SECRET_IDEMPOTENCY_KEY_ID: env.MENDPOINT_SECRET_IDEMPOTENCY_KEY_ID,
    MENDPOINT_SECRET_IDEMPOTENCY_KEY_BASE64: env.MENDPOINT_SECRET_IDEMPOTENCY_KEY_BASE64 ? "[set]" : undefined,
  };
