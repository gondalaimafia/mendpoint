...
export const metadata: Metadata = {
  ...
  description: "Current Warden pilot inputs, repository boundary, verification, and product status.",
  ...
  return (
    <div className="public-page public-document">
      <header>
        ...
        <h1>Supported Warden pilot scope</h1>
      ...
      <section>
        ...
        <ul className="public-list">
          ...
          <li>Warden does not merge pull requests.</li>
          <li>Transformer is an experimental planning preview.</li>
