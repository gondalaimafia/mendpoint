...
/**
 * Chooses the shell for a route. Console routes (/changes, /prs, /runs,
 * /settings and their children) render inside the DS `AppShell` supplied by
 ...
 */
const CONSOLE_PREFIXES = ["/changes", "/prs", "/runs", "/settings"] as const;
