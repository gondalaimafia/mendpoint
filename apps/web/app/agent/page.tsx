...
export default async function AgentPage() {
  ...
  error = [
    runsResult.status === "rejected" ? "Fettler runs are temporarily unavailable" : null,
    ...
    <div className="page">
      <div className="page-header">
        ...
        <p className="muted">
          ...
          pagination. Fettler works on a private candidate, reruns approved checks, and always
          requires review.
        </p>
      </div>
      ...
      <section className="card">
        ...
        <table className="table">
          <caption className="sr-only">Recent Fettler runs</caption>
          <thead>
            <tr>
              <th>When</th>
              <th>Status</th>
