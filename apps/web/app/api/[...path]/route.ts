...
function matchesAllowedRoute(method: string, path: string): boolean {
  ...
  const rules: Array<[string, RegExp]> = [
    ...
    ["GET", /^advanced-ai\/attestations\/[^/]+$/],
    ["GET", /^advanced-ai\/learning\/status$/],
    ["GET", /^advanced-ai\/post-trained\/(?:adapters|training-jobs|evaluations|canaries)\/[^/]+$/],
    ["POST", /^tenants\/[^/]+\/plan$/],
    ["POST", /^brands\/[^/]+\/preview$/],
    ["POST", /^agent\/runs$/],
    ["POST", /^fettler\/pilot$/],
    ...
    ["POST", /^advanced-ai\/learning\/(?:consents|corpora)$/],
    ["POST", /^advanced-ai\/learning\/consents\/[^/]+\/revoke$/],
    ["POST", /^advanced-ai\/attestations\/[^/]+\/verify$/],
    ["POST", /^advanced-ai\/post-trained\/adapters$/],
    ["POST", /^advanced-ai\/post-trained\/adapters\/[^/]+\/(?:rollback|eligibility|route-dry-run)$/],
    ["POST", /^advanced-ai\/post-trained\/(?:training-jobs|evaluations|canaries)$/],
