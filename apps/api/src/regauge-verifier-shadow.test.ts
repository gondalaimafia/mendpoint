...
function db(): AppDb {
  ...
  insertConnectedRepository(value, { id: "repo-a", tenantId: "tenant_regauge_canary", connectionId: "connection-a", remoteId: "123456", owner: "gondalaimafia", name: "mendpoint-canary-drill-20260801", defaultBranch: "main", selectedBranch: "codex/regauge-canary-baseline", environment: "production", retentionDays: 30, status: "ready", createdAt: "2026-08-24T12:00:00.000Z", updatedAt: "2026-08-24T12:00:00.000Z" });
  insertRepositorySnapshot(value, { id: "snapshot-a", tenantId: "tenant_regauge_canary", repositoryId: "repo-a", requestedRef: "codex/regauge-canary-baseline", resolvedSha: sha("a"), manifestSha256: "a".repeat(64), storagePath: root, fileManifestVersion: 1, createdAt: "2026-08-24T12:00:00.000Z", expiresAt: "2026-11-20T23:59:59.000Z" });
...
function env(): Record<string, string> {
  return {
    ...
    MENDPOINT_REGAUGE_VERIFIER_POLICY_ENVELOPE_JSON: JSON.stringify({ policyEnvelopeId: "regauge-deepseek-v4-flash-advisory-20260824", tenantId: "tenant_regauge_canary", version: 2, repositoryScope: ["gondalaimafia/mendpoint-canary-drill-20260801"], branchScope: ["codex/regauge-canary-baseline"], forbiddenZones: [], allowedTools: ["deepseek-verifier"], allowedModelClasses: ["rented_specialist"], externalProcessingAllowed: true, residency: "cn", riskCeiling: "high", reviewRequired: true, deploymentAllowed: false, trainingDataAllowed: false, retentionDays: 90, createdAt: "2026-08-24T00:00:00.000Z" }),
  };
}
