...
- [ ] Run the protected browser journey, crash recovery, and exact live health probes against the merged commit.
- [ ] Review and publish through protected CI, then record the remaining live-model, live-SCM, cost, soak, and Regauge production activation gaps.
