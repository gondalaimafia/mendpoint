...
- [ ] Close duplicate or superseded pull requests only after proving current main contains the reviewed replacement.
...
- [ ] Commit and push only the reviewed closure changes, obtain protected CI, and record remaining preserved worktrees that require an explicit archival or deletion decision.
