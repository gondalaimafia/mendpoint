...
- [ ] Add a regression matching the live GitHub response, run the affected package and activation gates, and merge the fix through protected CI before retrying activation.
