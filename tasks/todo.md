...
- Rebased onto `origin/main` 24590c4d (#587 merged mid-sweep carrying the byte-identical billing injection, so that file dropped out of this diff). Ten test files and this record changed; no product code.
