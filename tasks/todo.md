...
Observed `origin/main`: `5ba70419ef6164b51ba3bfdc38526bf96fa507d3`.
...
- [ ] Wave 0 Lane A: Claude owns the complete #515 authority repair. Do not push to `fix-open-pr-head-oracle` or edit `scripts/production-closure-*.ts` / `config/production-closure-*.json` / `docs/PRODUCTION_CLOSURE_MATRIX.json` from this branch.
