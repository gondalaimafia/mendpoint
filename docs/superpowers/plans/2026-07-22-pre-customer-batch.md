...
**Goal:** Close the pre-customer batch so Gauge is demoable, claim-safe, benchmarked internally, and shippable.
...
| A4 | GitHub Checks comment polish (Gauge) | `github/checks.ts` |
